...
// Edit this file to update copy, experience, skills, links, etc. — no other
// file needs to change for a content-only update.
...
export const affiliation = 'OWASP AppSec Member'
